"""Action-plan parsing for the conversational assistant path.

Pure functions and data types that turn raw model output (a JSON action plan)
into an immutable :class:`ActionPlanAction` tuple. No I/O and no side effects;
execution of the parsed plan lives in
